...
mysqldump --compatible=postgresql --default-character-set=utf8 -r countrylist.mysql -u root -p countrylist

docker cp  mysql:/countrylist.mysql /Users/clear/

python db_converter.py countrylist.mysql countrylist.psql
